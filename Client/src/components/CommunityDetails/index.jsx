...
const index = ({openCommunityDetails, setOpenCommunityDetails}) => {
    ...
    return (
        <div
            className={`absolute top-0 bg-white communit-details h-screen w-[80%] xs:w-[70%] sm:w-[55%] smd:w-[48%] md:w-[42%] lg:w-[35%] xl:w-[27%] z-50 transition-all duration-300 ease-linear ${openCommunityDetails
            ? "right-0"
            : "-left-full"}`}>
