const index = () => {
    return (
        <div className="px-4 py-3 flex justify-between w-full cursor-pointer">
            <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col justify-center h-full">
                    ...
                    <p className="text-sm text-[#737373] font-medium">Thank you so much</p>
                </div>
                <div className="flex flex-col items-end justify-center">
                    <p className="text-[14px] text-[#737373]">Just now</p>
                    <div className="w-[20px] h-[20px] bg-primary rounded-full flex items-center justify-center text-white text-sm">5</div>
                </div>
            </div>
        </div>
    );
